import { StyledDiv, StyledHeader, StyledLi, StyledParagraph, StyledUl } from "./WhyDrinkWater.styled";
    ...
    <StyledDiv>
      ...
      <StyledUl>
        ...
        <StyledLi>
          ...
          <StyledParagraph>Ensuring the stability of the internal environment</StyledParagraph>
        </StyledLi>
        <StyledLi>
          <svg fill="white" width="8" height="8">
            <use href={sprite + "#dot"}></use>
          </svg>
          <StyledParagraph>Maintaining within the normal temperature</StyledParagraph>
        </StyledLi>
        <StyledLi>
          <svg fill="white" width="8" height="8">
            <use href={sprite + "#dot"}></use>
          </svg>
          <StyledParagraph>Maintaining an immune system capable of resisting disease</StyledParagraph>
        </StyledLi>
      </StyledUl>
    </StyledDiv>
  );
