...
export const getPortionsList = createAsyncThunk("water/getPortionsList", async (_, thunkAPI) => {
   try {
...
export const deletePortion = createAsyncThunk("water/deletePortion", async (id, thunkAPI) => {
   try {
