...
export const BackgroundStyled = styled.div`
  ...
  background-image: url("/public/auth/BackgroundElementAuth-min.png");
  ...
  @media (min-width: 768px) {
    background-image: url("/public/auth/BackgroundBubblesAuthTablet-min.png");
    top: 90px;
    height: 100%;
    /* left: -20px; */
  }
  @media (min-width: 1440px) {
    background-image: url("/public/auth/BackgroundBubblesAuthDesktop-min.png");
